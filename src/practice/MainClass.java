...
public class MainClass {
    public static void main(String[] args) {
        ...
        list.add(new Employee("Anna", 28, 5000.0, "Male"));
        ...
        list.add(new Employee("Tanveer Ahmed", 33, 6000.0, "Male"));
        list.add(new Employee("Ria", 31, 7000.0, "Female"));
        list.add(new Employee("Anjali", 45, 55000.0, "Female"));
        list.add(new Employee("Siddarthhhhhhhhhhh", 2, 5000.0, "Male"));
        list.add(new Employee("Shanu", 32, 88000.0, "Male"));


        List<String> list1 = list.stream().map(Employee::getName).distinct().toList();
